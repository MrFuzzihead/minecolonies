...
/**
 * Message to set the World of the miner from the GUI.
 */
public class MinerSetLevelMessage extends AbstractBuildingServerMessage<BuildingMiner>
{
     ...
     */
    public MinerSetLevelMessage(@NotNull final IBuildingView building, final int World)
    {
        super(building);
        this.World = World;
    }
    ...
    {
        building.getModule(BuildingModules.MINER_LEVELS).setCurrentLevel(World);
    }
}
