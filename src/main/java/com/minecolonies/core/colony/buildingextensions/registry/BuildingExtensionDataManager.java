...
public final class BuildingExtensionDataManager
{
     ...
     */
    public static IBuildingExtension compoundToExtension(final @NotNull NBTTagCompound compound)
    {
        final ResourceLocation name = new ResourceLocation(compound.getString(TAG_EXTENSION_NAME));
        final int[] position = BlockPosUtil.read(compound, TAG_EXTENSION_POSITION);
     ...
     */
    public static IBuildingExtension resourceLocationToExtension(final @NotNull ResourceLocation registryName, final @NotNull int[] position)
    {
     ...
     * @return the building extension instance.
     */
    public static IBuildingExtension bufferToExtension(final @NotNull PacketBuffer buf)
    {
        final BuildingExtensionEntry entry = buf.readRegistryIdSafe(BuildingExtensionEntry.class);
        final int[] position = buf.readBlockPos();
     ...
     */
    public static PacketBuffer extensionToBuffer(final @NotNull IBuildingExtension extension)
    {
