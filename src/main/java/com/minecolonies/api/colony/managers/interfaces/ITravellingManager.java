...
public interface ITravellingManager
{
     ...
     */
    default Optional<int[]> getTravellingTargetFor(final ICitizenData citizenData)
    {
     ...
     * @return An optional with the travelling target. The optional is empty when the citizen is not travelling.
     */
    Optional<int[]> getTravellingTargetFor(final int citizenId);
     ...
     */
    default void startTravellingTo(final ICitizenData citizenData, final int[] target, final int travelTimeInTicks)
    {
     ...
     * @param travelTimeInTicks The time in ticks which needs to have passed for the travelling to complete.
     */
    void startTravellingTo(final int citizenId, final int[] target, final int travelTimeInTicks);
