...
public class CitizenEatFoodTrigger extends AbstractCriterionTrigger<CriterionListeners<CitizenEatFoodCriterionInstance>, CitizenEatFoodCriterionInstance>
{
    private static final ResourceLocation ID = new ResourceLocation(Constants.MOD_ID, Constants.CRITERION_CITIZEN_EAT_FOOD);
