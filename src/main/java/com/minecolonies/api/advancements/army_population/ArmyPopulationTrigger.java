...
public class ArmyPopulationTrigger extends AbstractCriterionTrigger<CriterionListeners<ArmyPopulationCriterionInstance>, ArmyPopulationCriterionInstance>
{
    private static final ResourceLocation ID = new ResourceLocation(Constants.MOD_ID, Constants.CRITERION_ARMY_POPULATION);
