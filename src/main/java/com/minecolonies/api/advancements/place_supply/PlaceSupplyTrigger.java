...
public class PlaceSupplyTrigger extends AbstractCriterionTrigger<CriterionListeners<PlaceSupplyCriterionInstance>, PlaceSupplyCriterionInstance>
{
    private static final ResourceLocation ID = new ResourceLocation(Constants.MOD_ID, Constants.CRITERION_SUPPLY_PLACED);
