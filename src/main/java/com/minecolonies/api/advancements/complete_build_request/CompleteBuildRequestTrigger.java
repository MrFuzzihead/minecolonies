...
public class CompleteBuildRequestTrigger extends AbstractCriterionTrigger<CriterionListeners<CompleteBuildRequestCriterionInstance>, CompleteBuildRequestCriterionInstance>
{
    private static final ResourceLocation ID = new ResourceLocation(Constants.MOD_ID, Constants.CRITERION_COMPLETE_BUILD_REQUEST);
